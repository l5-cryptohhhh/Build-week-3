...
- Nessun upload reale immagini, nessun WebSocket, nessuna notifica push/
  OAuth/pagamenti (fuori scope dichiarato). L'aggiornamento "quasi in
  tempo reale" di commenti e messaggi (vedi changelog 2026-07-21) e'
  realizzato con polling HTTP (`useInterval`), non WebSocket: un vero
  push resta nei prossimi passi.
